// Lydia Pierce
// CSCI 182
// BoatNames1.cpp : This file contains the 'main' function. Program execution begins and ends there.
// v1.0 2/17/2020
...
int main()
{
	...
	for (importCount = 0; importCount < MAX_BOAT_COUNT; importCount++)
	{
		std::cout << Fleet[importCount].Name << " " << Fleet[importCount].nYearBuilt << "\n";
	}
